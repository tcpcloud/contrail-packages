...
CONTRAIL_VROUTER_VERSION = $(VERSION)
...
VROUTER_REF := $(shell (cd vrouter; git log --oneline -1) | awk '/[0-9a-f]+/ { print $$1; }')
...
CONTRAIL_VROUTER_VERSION = 1.1master~$(VROUTER_REF)
WEBUI_CORE_VERSION = 1.1master~$(WEBUI_CORE_REF)
WEBUI_CONTROLLER_VERSION = 1.1master~$(WEBUI_CONTROLLER_REF)
